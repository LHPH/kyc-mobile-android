...
class MockNotificationsApi(
    ...
    override suspend fun getNotifications(): Response<ResponseData<List<NotificationDataResp>>> {
        ...
        val jsonResponse= if(BuildConfig.MOCK_ERROR_RESPONSE_GET_NOTIFICATIONS){
            context.readRawResource(R.raw.mock_error_response)
        }
        else{
            context.readRawResource(R.raw.mock_successful_response_get_notifications)
        }
        ...
        return if(BuildConfig.MOCK_ERROR_RESPONSE_GET_NOTIFICATIONS){
